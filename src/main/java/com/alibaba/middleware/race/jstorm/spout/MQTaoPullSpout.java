...
public class MQTaoPullSpout implements IRichSpout,IFailValueSpout{
	private static final Logger LOG = LoggerFactory.getLogger(MQTaoPullSpout.class);
...
//                                pullResult.getPullStatus(), pullResult);
	...
	public void fail(Object msgId, List<Object> values) {
		TairImpl.writeFails("taobao_"+(String)msgId);
