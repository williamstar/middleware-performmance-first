...
public class RaceTopology {
	...
	public static void main(String[] args) throws Exception {
		...
		builder.setBolt("taoSortBolt", new TaoSortBolt(),4).localOrShuffleGrouping("taoSpout");
		builder.setBolt("tmallSortBolt", new TmallSortBolt(),4).localOrShuffleGrouping("tmallSpout");
		builder.setBolt("paySortBolt", new PaySortBolt(),8).localOrShuffleGrouping("paySpout");
